        ...
        return (
                <section id="facts">
                        <div className="container-satu">
                            ...
                            <p className="description">"You won't need to leave the hotel because evrything is there. The food was delicious and there was plenty of choice for breakfast. It was reasonably priced too."</p>
